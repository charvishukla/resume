...
\begin{center}
    ...
    \href{https://www.linkedin.com/in/charvi-shukla/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/charvi-shukla}}  ~
    \href{https://github.com/charvishukla}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/charvishukla}}
    \vspace{-8pt}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheadings
      {University of California, San Diego}{Sep. 2021 -- May 2025}
      {BS. Mathematics-Computer Science}{La Jolla, CA}
      {BS. Cognitive Science with a Specialization in Machine Learning and Neural Computation}
